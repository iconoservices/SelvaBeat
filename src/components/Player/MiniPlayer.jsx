    ...
    return (
        ...
        >
            ...
            <div className="w-18 h-18 shrink-0 relative overflow-hidden">
                <img src={videoData.thumbnail} className="w-full h-full object-cover filter saturate-[1.2] brightness-75 group-hover:brightness-100 transition-all duration-500" alt="thumb" />
                {isLoading && (
            ...
            <div className="flex-1 px-4 overflow-hidden">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <p className="text-[8px] text-white/40 font-bold truncate uppercase tracking-[0.15em]">{videoData.uploader}</p>
                </div>
            </div>
